...
from .models import Variant, UserVariant, Recommendation, Publication
...
class VariantsTests(TestCase):
    ...
    def setUp(self):
        ...
        self.vcf_content = b'# rsid	chromosome	position	genotype\n'\
            b'rs4477212	1	82154	AA\n'\
            b'rs3094315	1	752566	AA\n'
        self.vcf_content_single_snp = b'# rsid	chromosome	position	genotype\n'\
    ...
    def test_submit_data(self):
        responses.add(responses.GET, 'https://myvariant.info/v1/variant/rs4477212',
                  json={
                    'gwassnps': {
                        'pubmed': 21878437,
        ...
        responses.add(responses.GET, 'https://myvariant.info/v1/variant/rs3094315',
                  json={
                    'gwassnps': {
                        'pubmed': 21878438,
        ...
        response = self.client.post(reverse('variant_upload'), {'vcf_file': file}, follow=True)
    ...
    def test_submit_data_multiple_entries_in_response(self):
        responses.add(responses.GET, 'https://myvariant.info/v1/variant/rs4477213',
                  json=[
                    {
                        'gwassnps': {
                            'pubmed': 21878440,
    ...
    def test_variant_detail(self):
        ...
        response = self.client.get(user_variant.get_absolute_url())
